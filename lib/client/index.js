...
function kittenMQ () {
  ...
  function connect (config, callback) {
    ...
    if (cluster.isWorker) {
      _config.clientId += '_' + cluster.worker.id;
    }
  ...
  function send (channel, data, callback) {
    ...
    if (callback) {
      // Register handler
      _handlers[_id] = (err, data, info) => {
        callback(err, data, info);
        delete _handlers[_id];
      };
    }
  ...
  function listen (channel, callback) {
    ...
    return {
      ...
      addId : function (id, callback) {
        ...
        if (callback) {
          // Register handler
          _handlers[_idAdd] = (err) => {
            callback.call(null, err);
          };
        }
        _hosts.broadcast(_config.clientId, _config.privateKey, routes.QUEUE_LISTEN_ADD_ID, _idAdd, { id : id, handlerId : _id, channel });
      },
      ...
      removeId : function (id, callback) {
        ...
        if (callback) {
          // Register handler
          _handlers[_idRemove] = (err) => {
            callback.call(null, err);
          };
        }
        _hosts.broadcast(_config.clientId, _config.privateKey, routes.QUEUE_LISTEN_REMOVE_ID, _idRemove, { id : id, handlerId : _id, channel });
      }
    }
  }
  ...
  function consume (channel, callback) {
    ...
    return {
      ...
      addId : function (id, callback) {
        ...
        _hosts.broadcast(_config.clientId, _config.privateKey, routes.QUEUE_CONSUME_ADD_ID, _idAdd, { id : id, handlerId : _id, channel });
      },
      ...
      removeId : function (id, callback) {
        ...
        _hosts.broadcast(_config.clientId, _config.privateKey, routes.QUEUE_CONSUME_REMOVE_ID, _idRemove, { id : id, handlerId : _id, channel });
      }
    }
  }
