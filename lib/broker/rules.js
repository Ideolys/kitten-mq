    ...
    isAllowed : function (client, channelParts, isRead = true) {
      ...
      if (!_rules[channelParts.endpoint][channelParts.version]) {
        if (!_rules[channelParts.endpoint]['*']) {
          ...
          channelParts.version = '*';
        }
      }

      if (channelParts.version === '*') {
        _res = _isClientInList(_rules[channelParts.endpoint][channelParts.version], client);
      ...
      if (!_rules[channelParts.endpoint][channelParts.version][channelParts.ids]) {
        if (!_rules[channelParts.endpoint][channelParts.version]['*']) {
          _cache[_cacheKey] = _res && !_isClientHasRules;
          return _cache[_cacheKey];
        }
      ...
      _res = _isClientInList(_rules[channelParts.endpoint][channelParts.version][channelParts.ids], client);
