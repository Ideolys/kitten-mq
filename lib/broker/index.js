...
function broker (configPath, isProd = false) {
  ...
  function _sendToClients (acks, clients, item, headers, isQueue = true, error = null) {
    for (var i = 0; i < clients.length; i++) {
      ...
      _packet.headers.messageId = _packet.headers.messageId || utils.randU32Sync(), // messgaeID = handlerId, because send method is self-destructive
      ...
      if (isQueue) {
        acks[_packet.headers.messageId] = _packet.headers;
      }
